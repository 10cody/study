...
![avatar](../../images/mysql/mysql_16_1.png)
...
![avatar](../../images/mysql/mysql_16_2.png)
...
![avatar](../../images/mysql/mysql_16_3.png)
...
![avatar](../../images/mysql/mysql_16_4.png)
...
![avatar](../../images/mysql/mysql_16_5.png)
...
![avatar](../../images/mysql/mysql_16_6.png)
...
![avatar](../../images/mysql/mysql_16_7.png)
...
![avatar](../../images/mysql/mysql_16_8.png)

图 8 引入 (city,name) 联合索引后，查询语句的执行计划
可以看到，这个查询过程不需要临时表，也不需要排序。接下来，我们用 explain 的结果来印证一下。

![avatar](../../images/mysql/mysql_16_9.png)
...
![avatar](../../images/mysql/mysql_16_10.png)

图 10 引入 (city,name,age) 联合索引后，查询语句的执行流程
然后，我们再来看看 explain 的结果。

![avatar](../../images/mysql/mysql_16_11.png)
...
![avatar](../../images/mysql/mysql_16_12.png)
...
![avatar](../../images/mysql/mysql_16_13.png)
...
![avatar](../../images/mysql/mysql_16_15.png)
